...
exec chrome_driver & chromium-browser --headless --no-sandbox --hide-scrollbars --no-first-run --disable-sync --enable-automation --disable-popup-blocking --disable-prompt-on-repost \
    ...
    --autoplay-policy=user-gesture-required --disable-gpu --mute-audio --disable-client-side-phishing-detection --ignore-certificate-errors --disable-component-extensions-with-background-pages \
    --disable-dev-shm-usage --disable-backgrounding-occluded-windows --disable-breakpad --disable-default-apps --enable-logging=0 \
